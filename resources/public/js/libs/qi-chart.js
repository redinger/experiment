...
var QIchart = {
    ...
    */
    ...
    dates: function(pairs) { return _.toArray(_.map(pairs, function(p) { return p.ts; })) },
    values: function(pairs) { return _.toArray(_.map(pairs, function(p) { return p.v; })) },
    ...
    renderSeries: function (chart,series,cfg,mean) {
        ...
        var xsel = function (d,i) { return x(d.ts); };
        var ysel = function (d,i) { return y(d.v); };
...
/*		this.boundingBox(chart, cfg); */
		...
		this.renderSeries(chart,series,cfg,true);
